...
import './style.css'
export const AdapatoareHranitoare = (props) => {

    const [produse, setProduse]=useState([]);
 const getProduse = async () => {
   try {
    const querySnapshot = await getDocs(collection(db, "Pasari/Pasari/AdapatoareHranitoare"));
      ...
      <button className='btn' >Inapoi</button>
            ...
            {produse.length > 0 && (
                <div className='container-fluid'>
                    <h1 className='text-center-pasari'  data-heading='Adăpătoare și hrănitoare'>Adăpătoare și hrănitoare</h1>
