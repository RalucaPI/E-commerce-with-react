...
import './style.css'
export const LZH = (props) => {
    const [produse, setProduse]=useState([]);

  const getProduse = async () => {
   try {
    const querySnapshot = await getDocs(collection(db, "Pisici/Pisici/LZH"));
      ...
      <button className='btn' >Inapoi</button>
            ...
            {produse.length > 0 && (
                <div className='container-fluid'>
                    <h1 className='text-center-pisici'  data-heading='Lese, zgărzi și hamuri'>Lese, zgărzi și hamuri</h1>
