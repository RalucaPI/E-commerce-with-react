...
import { collection, getDocs,setDoc, doc, updateDoc, getDoc ,query, where } from 'firebase/firestore'
import { Link, useNavigate } from 'react-router-dom';
import { FilterByBrand } from '../FilterByBrand';
import './style.css'
export const Jucarii = (props) => {
...
const getProduse = async () => {
  try {
    let q = query(collection(db, "Pisici/Pisici/Jucarii"));
    ...
    return (
      ...
      {produse.length > 0 && (
        <div className='container-fluid'>
          <h1 className='text-center-pisici' data-heading='Jucării'>Jucării</h1>
