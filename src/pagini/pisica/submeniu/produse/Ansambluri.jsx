...
import './style.css'
export const Ansambluri = (props) => {
  
    const [produse, setProduse]=useState([]);
 const getProduse = async () => {
   try {
    const querySnapshot = await getDocs(collection(db, "Pisici/Pisici/Ansambluri"));
      ...
      <button className='btn' >Inapoi</button>
            ...
            {produse.length > 0 && (
                <div className='container-fluid'>
                    <h1 className='text-center-pisici'  data-heading='Ansambluri'>Ansambluri</h1>
