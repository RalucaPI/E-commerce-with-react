...
import './style.css'
export const Igiena = (props) => {
    const [produse, setProduse]=useState([]);

 const getProduse = async () => {
   try {
    const querySnapshot = await getDocs(collection(db, "Pisici/Pisici/Igiena"));
      ...
      <button className='btn' >Inapoi</button>
            ...
            {produse.length > 0 && (
                <div className='container-fluid'>
                    <h1 className='text-center-pisici'  data-heading='Igienă'>Igienă</h1>
