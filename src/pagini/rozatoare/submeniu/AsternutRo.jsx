...
import './style.css'
export const AsternutRo = (props) => {
   const [produse, setProduse]=useState([]);
    const getProduse = async () => {
   try {
    const querySnapshot = await getDocs(collection(db, "Rozatoare/Rozatoare/Asternut"));
      ...
      <button className='btn' >Inapoi</button>
            ...
            {produse.length > 0 && (
                <div className='container-fluid'>
                    <h1 className='text-center-rozatoare' data-heading='Așternut'>Așternut</h1>
