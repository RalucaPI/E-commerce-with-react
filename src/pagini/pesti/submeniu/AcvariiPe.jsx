...
import './style.css'
export const AcvariiPe = (props) => {
    const [produse, setProduse]=useState([]);

  const getProduse = async () => {
   try {
    const querySnapshot = await getDocs(collection(db, "Pesti/Pesti/Acvarii"));
      ...
      <button className='btn' >Inapoi</button>
          ...
          <div className='container-fluid'>
            <div className='content-pesti'>
                    <h1 className='text-center-pesti'>Acvarii</h1>
                    <h1 className='text-center-pesti'>Acvarii</h1></div>
