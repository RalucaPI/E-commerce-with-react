...
import './style.css'
export const SolutiiApa = () => {
    const [produse, setProduse]=useState([]);

  const getProduse = async (props) => {
   try {
    const querySnapshot = await getDocs(collection(db, "Pesti/Pesti/SolutiiApa"));
    ...
    return (
      ...
      <button className='btn' >Inapoi</button>
          ...
          <div className='container-fluid'>
            <div className='content-pesti-solutii'>
                    <h1 className='text-center-pesti'>Solutii pentru apa</h1>
                    <h1 className='text-center-pesti'>Solutii pentru apa</h1></div>
