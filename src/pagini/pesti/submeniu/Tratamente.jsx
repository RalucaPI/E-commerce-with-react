...
import './style.css'
export const Tratamente = (props) => {
    const [produse, setProduse]=useState([]);

  const getProduse = async () => {
   try {
    const querySnapshot = await getDocs(collection(db, "Pesti/Pesti/Tratamente"));
    ...
    return (
      ...
      <button className='btn' >Inapoi</button>
          ...
          <div className='container-fluid'>
            <div className='content-pesti'>                 <h1 className='text-center-pesti'>Tratamente</h1>
                    <h1 className='text-center-pesti'>Tratamente</h1></div>   
