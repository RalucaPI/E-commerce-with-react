...
import './style.css'
export const AccesoriiPe = (props) => {
    const [produse, setProduse]=useState([]);

  const getProduse = async () => {
   try {
    const querySnapshot = await getDocs(collection(db, "Pesti/Pesti/Accesorii"));
    ...
    return (
      ...
      <button className='btn' >Inapoi</button>
          ...
          <div className='container-fluid'>
            <div className='content-pesti'>
                    <h1 className='text-center-pesti'>Accesorii</h1>
                    <h1 className='text-center-pesti'>Accesorii</h1></div>
