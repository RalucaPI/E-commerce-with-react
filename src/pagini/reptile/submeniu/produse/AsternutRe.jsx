...
import './style.css'
export const AsternutRe = (props) => {
   const [produse, setProduse]=useState([]);
    const getProduse = async () => {
   try {
    const querySnapshot = await getDocs(collection(db, "Reptile/Reptile/Asternut"));
      ...
      <button className='btn' >Inapoi</button>
            ...
            {produse.length > 0 && (
                <div className='container-fluid'>
                    <h1 className='text-center-reptile' data-heading='Așternut'>Așternut</h1>
