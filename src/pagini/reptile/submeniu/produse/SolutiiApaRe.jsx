...
import './style.css'
export const SolutiiApaRe = (props) => {
    const [produse, setProduse]=useState([]);

  const getProduse = async () => {
   try {
    const querySnapshot = await getDocs(collection(db, "Reptile/Reptile/SolutiiApa"));
      ...
      <button className='btn' >Inapoi</button>
            ...
            {produse.length > 0 && (
                <div className='container-fluid'>
                    <h1 className='text-center-reptile' data-heading='Soluții pentru apă'>Soluții pentru apă</h1>
