...
import './style.css'
export const CastroaneC = (props) => {
  const navigate = useNavigate();
     const [produse, setProduse]=useState([]);
     const getProduse = async () => {
   try {
    const querySnapshot = await getDocs(collection(db, "Caini/Caini/Castroane"));
      ...
      <button className='btn' >Inapoi</button>
            ...
            {produse.length > 0 && (
                <div className='container-fluid'>
                    <h1 className='text-center-caini' data-heading='Castroane'>Castroane</h1>
