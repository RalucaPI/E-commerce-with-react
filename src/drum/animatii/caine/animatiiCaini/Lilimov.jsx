...
export function Lilimov(props) {
  const { nodes, materials } = useGLTF('../drum/caini/lilimov/scene-transformed.glb')
  return (
...
useGLTF.preload('../drum/caini/lilimov/scene-transformed.glb')
