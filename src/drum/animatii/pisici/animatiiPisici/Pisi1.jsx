...
export function Pisi1(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('../drum/pisici/pisi1/scene-transformed.glb')
...
useGLTF.preload('../drum/pisici/pisi1/scene-transformed.glb')
