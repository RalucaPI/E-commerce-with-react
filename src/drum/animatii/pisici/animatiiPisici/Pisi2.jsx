...
export function Pisi2({ opacity, ...props }) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('../drum/pisici/pisi2/scene-transformed.glb')
              ...
              <group name="Sketchfab_model_0" rotation={[-Math.PI / 2, 0, 0]}>
                <group name="root_1">
                  <group name="GLTF_SceneRootNode_2" rotation={[Math.PI / 2, 0, 0]}>
                    <group name="Sketchfab_model_0_3" rotation={[-Math.PI / 2, 0, 0]} scale={1.82}>
                      <group name="root_1_4">
...
useGLTF.preload('../drum/pisici/pisi2/scene-transformed.glb')
