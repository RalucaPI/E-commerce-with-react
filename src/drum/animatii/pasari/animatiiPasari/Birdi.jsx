...
export function Birdi(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('../drum/pasari/birdi/scene-transformed.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]} scale={46.68}>
          <group name="bfb1ea86655f4c4ab4c6cbbb449cedf4fbx" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
            <group name="Object_2">
              <group name="RootNode">
                <group name="BirdOrange_all">
                  <group name="Main" position={[-0.08, 0, 0.45]} rotation={[0, -0.07, 0]}>
                    <group name="Object_6">
...
useGLTF.preload('../drum/pasari/birdi/scene-transformed.glb')
