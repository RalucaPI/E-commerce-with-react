...
const Image = styled.div`
  ...
  border-radius: 1rem;
  background-image: url(https://e1.pxfuel.com/desktop-wallpaper/1005/210/desktop-wallpaper-%EC%8B%A0%EC%9C%A4%EC%84%9C-on-ikan-cupang-betta-fish-face-thumbnail.jpg);
`;
...
export function ContainerPesti({ height = 300, width = 470 }) {
  ...
  const isRedirectedPage = location.pathname === "/pești";
  return (
    <>
