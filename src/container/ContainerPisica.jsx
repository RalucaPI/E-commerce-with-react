...
const Image = styled.div`
  ...
  border-radius: 1rem;
  background-image: url(https://www.mykittensite.com/images/boarding.jpg);
`;
...
export function ContainerPisica({ height = 300, width = 500 }) {
  ...
  const isRedirectedPage = location.pathname === "/pisici";
  return (
    <>
