...
const Image = styled.div`
  ...
  border-radius: 1rem;
  background-image: url(https://c0.wallpaperflare.com/preview/842/402/462/singapore-jurong-bird-park-bird-portrait.jpg);
`;
...
export function ContainerPasari({ height = 300, width = 530 }) {
...
///////////  
  const isRedirectedPage = location.pathname === "/păsări";
  return (
    <>
