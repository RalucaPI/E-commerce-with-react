...
const Image = styled.div`
  ...
  border-radius: 1rem;
  background-image: url(https://www.hdwallpapers.in/thumbs/2020/eurasian_red_squirrel_hd_squirrel-t2.jpg);
`;
...
export function ContainerRozatoare({ height = 250, width = 450 }) {
  ...
  const isRedirectedPage = location.pathname === "/rozătoare";
  return (
    <> 
