...
const Image = styled.div`
  ...
  border-radius: 1rem;
  background-image: url(https://wallpapershome.com/images/pages/pic_h/9985.jpg);
`;
...
export function ContainerReptile({ height = 150, width = 250 }) {
  ...
  const isRedirectedPage = location.pathname === "/reptile";
  return (
    <>
