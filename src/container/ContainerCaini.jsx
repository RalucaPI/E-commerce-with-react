...
const Image = styled.div`
  ...
  border-radius: 1rem;
  background-image: url(https://easypet.com/wp-content/uploads/2022/07/dog-food-101.webp);
`;
...
export function ContainerCaini({ height = 200, width = 350 }) {
...
////////////////////////////////
  const isRedirectedPage = location.pathname === "/câini";
  return (
    <>
